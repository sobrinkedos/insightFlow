  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-secondary/20 text-secondary border-secondary/30 hover:bg-secondary/30",
        destructive:
          "border-transparent bg-destructive/20 text-destructive border-destructive/30 hover:bg-destructive/30",
        outline: "text-foreground border-border/50 hover:bg-primary/10",
      },
    },
    defaultVariants: {
      variant: "default",
